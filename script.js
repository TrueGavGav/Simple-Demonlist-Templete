document.addEventListener("DOMContentLoaded", function() {
  ...
  { 
    ...
    completions: [
      { record: { text: "RecordText1", link: "RecordLink1" }, verifier: { name: "VerifierName1", link: "VerifierLink1" } },
  ...
  { 
    name: "Player1", 
    points: 100, 
    verifiedLevels: ["Level1", "Level2"], 
    completedLevels: ["Level3", "Level4"] 
  },
  { 
    name: "Player2", 
    points: 120, 
    verifiedLevels: ["Level2", "Level5"], 
    completedLevels: ["Level1", "Level6"] 
  },
